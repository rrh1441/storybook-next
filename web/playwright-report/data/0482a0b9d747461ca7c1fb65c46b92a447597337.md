...
- Name: Authentication flow >> dashboard redirects to login when not authenticated
- Location: /Users/ryanheger/storybook-next/web/tests/create-flow.spec.ts:73:7

# Error details

```
Error: browserType.launch: Executable doesn't exist at /Users/ryanheger/Library/Caches/ms-playwright/firefox-1482/firefox/Nightly.app/Contents/MacOS/firefox
╔═════════════════════════════════════════════════════════════════════════╗
